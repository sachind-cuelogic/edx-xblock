...
class ReferenceXBlock(XBlock):
    ...
    def student_view(self, context=None):
        ...
        fragment = Fragment()
        fragment.add_content(loader.render_template('templates/referenceview.html', context))
        return fragment   


        # fragment = Fragment(self.render_template("referencexblock.html", context))
    ...
    def studio_view(self, context=None):
        ...
        # fragment = Fragment(self.render_template("templates/referencexblock.html"))
