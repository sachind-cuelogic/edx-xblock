...
from .models import XBlockState, Course, Lessons, KeyDefinition
...
# def show_scenario(request, scenario_id, view_name='studio_view', template='workbench/block.html'):
    """
